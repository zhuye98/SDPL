...
from models.CheXRelFormerBaseNetworks import *
...
class EncoderTransformer_v3(nn.Module):
    ...
    def forward_features(self, x):
        ...
        # stage 2
        x1, H1, W1 = self.patch_embed2(x1) # x1: [B, 32*32, 128]
        ...
        # stage 3
        x1, H1, W1 = self.patch_embed3(x1) # x1: [B, 16*16, 320]
        ...
        # stage 4
        x1, H1, W1 = self.patch_embed4(x1) # x1: [B, 8*8, 512]
...
# SDPL_decoder:
class SDPL_DecoderTransformer_v3(nn.Module):
    """
    Transformer Decoder
    """
    def __init__(self, input_transform='multiple_select', in_index=[0, 1, 2, 3], align_corners=True, 
        ...
        super(SDPL_DecoderTransformer_v3, self).__init__()
        #assert
...
class CheXRelFormer_plain(nn.Module):
    ...
    def __init__(self, input_nc=3, output_nc=3, embed_dim=256, input_transform='multiple_select', decoder_softmax=False):
        ...
        self.conv_prog = conv_diff_symp(1024, 512)
        self.prog_pred = nn.Linear(512, output_nc)
    ...
    def forward(self, x1, x2):
        ...
        prog_feat = torch.cat((feat_A_last, feat_B_last), dim=1)
        prog_feat = self.conv_prog(prog_feat) # [BS, hid_dim, h, w]
        prog_feat = self.adapt_avg_pooling(prog_feat).flatten(1)
        prog_pred = self.prog_pred(prog_feat)
