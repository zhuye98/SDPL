...
# Original code of CHEXRELFORMER

output_dir = '~/physionet.org/files/chest-imagenome/1.0.0/gk_parser_code'
comp_df = pd.read_csv('~/physionet.org/files/chest-imagenome/1.0.0/silver_dataset/scene_tabular/comparison_relations_tabular.txt', sep='\t')
...
comp_df.to_csv(os.path.join(output_dir,'final_comparison_dataset.txt'), sep='\t',encoding='utf-8',index=False)
