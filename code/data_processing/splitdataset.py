...
file_path = "~/physionet.org/files/chest-imagenome/1.0.0/gk_parser_code/final_comparison_dataset.txt"
bbox_file_path = "~/physionet.org/files/chest-imagenome/1.0.0/silver_dataset/scene_tabular/bbox_objects_tally.txt"
splits=  ["~/physionet.org/files/chest-imagenome/1.0.0/silver_dataset/splits/train.csv", 
          "~/physionet.org/files/chest-imagenome/1.0.0/silver_dataset/splits/valid.csv", 
          "~/physionet.org/files/chest-imagenome/1.0.0/silver_dataset/splits/test.csv"]
...
def split_dataset(file_path, bbox_file_path, splits):
    ...
    dev.to_csv('~/data/split/val.csv', index=False)
