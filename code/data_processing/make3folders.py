...
df = pd.read_csv('~/data/split/train.csv', header=0)
# df = pd.read_csv('~/data/split/val.csv', header=0)
# df = pd.read_csv('~/data/split/test.csv', header=0)
...
for idx, row in df.iterrows():
    ...
    label_path = '~/data/label/' + new_img_name.split(".")[0] + '.txt'
